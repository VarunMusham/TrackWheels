<h1 align="center">TrackWheels</h1><p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=arduino,cpp,javascript,nodejs,react,git,vercel,supabase" />
  </a>
</p>
...
<p>The ESP8266 board reads the GPS data from the Neo-6M module and sends the vehicle coordinates to a Supabase cloud database.</p>
<!-- Node JS Needed-->
<h2>Software</h2>
